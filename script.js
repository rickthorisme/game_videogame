...
const scenes = [
    {
        ...
        author: 'Muhammad Thoriq', // Your name
        codepenprofile: 'Rickthor7', // Your Codepen profile link
        twitterprofile: 'rickthor7', // Your Codepen profile link
...
$(answer).click(function() {
    ...
    if(!transitioning) {
        ...
        if(progress == $('.scene').length + 1) {
            ...
            $('p.score').html('Kamu dapat ' + $('.breadcrumb.correct').length + ' ari nilai 5!')
        }
